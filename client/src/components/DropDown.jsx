...
const DropDown = ({ label, name, options, init, onChange, multiple = false }) => (
    <div className='flex flex-col mx-4'>
        ...
        <select className='w-64 border-2 border-blue-600 border-solid outline-none rounded p-3 appearance-none select-bg' id={name} onChange={onChange} multiple={multiple} name={name} defaultValue='none'>
